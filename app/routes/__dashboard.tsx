...
import {Dialog, SelectChevronIcon} from '@mantine/core'
...
export default function DashboardLayout() {
	const {user, rentedMedia} = useLoaderData<typeof loader>()
					...
					<div className="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
						...
						<nav className="px-3 mt-6">
							<div className="space-y-4">
								<p className="bg-white text-black p-4 flex items-center justify-center">
									Book balance:{' '}
									{rentedMedia.length > 0 ? rentedMedia.length : 0}
								</p>
